  ...
  return (
    <div>
      ...
      <div className='flex justify-between'>
        <div className='grid grid-cols-1  sm:grid-cols-2  md:grid-cols-3  lg:grid-cols-3 justify-baseline gap-5 items-start text-blue-500 text-xl mt-2 font-bold ml-10 '>
